---
layout: distill
title: Have we reached the “BERT Moment” for Time Series?
description: Highlights from the NeurIPS 2025 Workshop
tags: 
...
authors:
  ...
  - name: Romain Tavenard
    url: "https://rtavenar.github.io/research/bio.html"
    affiliations:
      name: Inria, Univ. Rennes 2
  - name: Valentina Zantedeschi
    url: "https://vzantedeschi.com/"
    affiliations:
      name: ServiceNow 
bibliography: 2018-12-22-distill.bib

toc:
  - name: "Why are we late to the game?"
  - name: "Generalization vs. specificity: can one model do it all?"
  - name: "Moving beyond forecasting (and the MAE trap)"
  - name: "What are the next steps for the community?"
  - name: "Conclusion: a call to action"
---
...
### Generalization vs. specificity: can one model do it all?
...
If you are interested in participating, **please fill in [this form](https://docs.google.com/forms/d/e/1FAIpQLSdTAl-KskFMXC_qXQFC0txJdyOGvHK4eymFF9DUYm5iNpef0w/viewform)**, so we can organize the logistics.
Let's all come together to help the Time Series community achieve its foundation model breakthrough!
